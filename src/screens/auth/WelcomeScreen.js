...
const defaultProps = {
    illustrations: [
      { id: 1, source: require('../../../assets/images/ilu_4.jpg') },
      { id: 2, source: require('../../../assets/images/ilu_3.jpg') },
      { id: 3, source: require('../../../assets/images/ilu_1.jpg') },
    ],
  };
        ...
        <View style={styles.container}> 
            <View style={styles.container1}>
                <Text style={{fontSize: sizes.h1, textAlign: "center", fontWeight: "bold"}}>
                    Dentocare.
                    <Text style={{fontSize: sizes.h1, color: colors.primary}}>Club </Text>
                </Text>
                <Text style={{fontSize: sizes.h3, color: colors.gray2, marginTop: sizes.padding / 2}}>
                    Enjoy the experience of dental health care
                </Text>
            </View>
